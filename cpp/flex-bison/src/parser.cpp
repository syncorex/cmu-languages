...
{
      -1,    -1,   -10,   -10,     7,    -9,   -10,     0,     5,   -10,
      -3,   -10,    -1,    -1,    -1,    -1,    -1,   -10,   -10,     5,
       5,   -10,   -10
};
...
{
       5,     0,    15,    16,     0,     2,     4,     6,     8,    12,
       0,     1,     5,     0,     0,     0,     0,    17,     3,     7,
       9,    11,    13
};
...
{
      13,    14,    12,    13,    14,    17,     1,    11,     2,     3,
      15,    16,    10,     0,    19,    20,    18,    21,    22
};

static const yytype_int8 yycheck[] =
{
       3,     4,    11,     3,     4,     8,     7,     0,     9,    10,
       5,     6,     1,    -1,    13,    14,    12,    15,    16
};
...
#line 45 "src/parser.y"
            { yyval = ParseTree::e_sub(yyvsp[-2],yyvsp[-1],yyvsp[0]); }
...
#line 53 "src/parser.y"
            { yyval = ParseTree::t_div(yyvsp[-2],yyvsp[-1],yyvsp[0]); }
